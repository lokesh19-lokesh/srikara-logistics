        ...
        <main className="bg-[#f8f9fa] min-h-screen">
            ...
            <section className="max-w-7xl mx-auto px-6 py-24 md:py-32">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div>
                        <h2 className="text-3xl md:text-5xl font-bold tracking-tighter text-black mb-8">
                    ...
                    <div className="relative aspect-video rounded-2xl overflow-hidden bg-black/5 border border-black/10 flex items-center justify-center">
                        <div className="text-black/20 font-black text-4xl italic">Srikara Logistics</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mt-32">
                    {values.map((v, i) => (
                        <div key={i} className="p-8 rounded-2xl bg-white border border-black/10 hover:border-corporate/50 transition-all group shadow-sm">
                            <h3 className="text-xl font-bold text-black mb-4 group-hover:text-corporate transition-colors">{v.title}</h3>
                            <p className="text-black/50 text-sm leading-relaxed">{v.description}</p>
                        </div>
                    ))}
                </div>
            </section>
