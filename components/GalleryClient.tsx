    ...
    return (
        <>
            <section className="max-w-7xl mx-auto px-6 py-24">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {images.map((img, i) => (
                        <div
                            ...
                            className="aspect-square rounded-2xl bg-white border border-black/10 overflow-hidden relative group cursor-pointer shadow-md"
                        >
                            <img
                            ...
                            <div className="absolute inset-0 bg-black/30 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center backdrop-blur-[2px]">
                                <div className="w-12 h-12 rounded-full bg-white/20 border border-white/40 flex items-center justify-center text-white backdrop-blur-md">
                ...
                <div className="mt-12 text-center text-black/40 text-sm font-medium">
